                    ...
                    <li class="list-group-item align-items-center d-flex justify-content-between pt-0">
                        <div class="media">
                            ...
                            <div class="media-body align-self-center">
                                <h6 class="m-0">Infant Dashboard</h6>
            ...
            <div class="card-body">
                <div class="table-responsive browser_users">
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td><img src="{{ asset('assets/images/browser_logo/chrome.png') }}"
                            ...
                            <tr>
                                <td><img src="{{ asset('assets/images/browser_logo/micro-edge.png') }}"
                            ...
                            <tr>
                                <td><img src="{{ asset('assets/images/browser_logo/in-explorer.png') }}"
                                        alt="" height="16"
                            ...
                            <tr>
                                <td><img src="{{ asset('assets/images/browser_logo/opera.png') }}"
